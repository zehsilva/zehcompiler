...
******/
  ...
  public static void main(String args []) throws ParseException
  {
      ...
      System.out.print("ZEL Parser"+"\u005cn Arquivo: "+args[0]+"\u005cn");
      try {
                 fp=new FileInputStream(args[0]);
         analisador = new ZelParser(fp);
         cmdlst=inicio();
         System.out.println(tab);
         CodigoDestino cod=new CodigoDestino(args[0],cmdlst,tab );
         cod.geraCod();
      }
...
//------------------------------if,while e foreach---------------------------------------------
  static final public Comando ifcmd(LinkedList<Comando> coms) throws ParseException, SemanticException {
 ComandoIF com;
char tipo;
...
ArrayDeque<Item> lst=new ArrayDeque<Item>();
  ...
  static final public Comando whilecmd(LinkedList<Comando> coms) throws ParseException, SemanticException {
...
ArrayDeque<Item> lst=new ArrayDeque<Item>();
  ...
  static final public Comando foreach(LinkedList<Comando> coms) throws ParseException, SemanticException {
 Token t;char tipo;Comando com=new Comando();
LinkedList<Comando> comsnovo=new LinkedList<Comando>();
ArrayDeque<Item> lst=new ArrayDeque<Item>();
...
//----------------------------------Entrada e Saida------------------------------------------
  static final public Comando entrada(LinkedList<Comando> coms) throws ParseException, SemanticException {
 Comando com=new Comando();
  ...
  static final public Comando saida(LinkedList<Comando> coms) throws ParseException, SemanticException {
 Comando com=new Comando();
ArrayDeque<Item> lst=new ArrayDeque<Item>();
