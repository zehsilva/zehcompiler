/* Generated By:JavaCC: Do not edit this line. JavaCPascalTokenManager.java */
import java.io.*;

/** Token Manager. */
public class JavaCPascalTokenManager implements JavaCPascalConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               case 0:
                  ...
                  else if ((0x2000000200000000L & l) != 0L)
...
/** Constructor. */
public JavaCPascalTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public JavaCPascalTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
